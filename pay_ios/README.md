...
If you prefer to integrate or extend this package separately, add `pay_ios` as a [dependency in your `pubspec.yaml` file](https://flutter.io/platform-plugins/) as follows:

```shell
flutter pub add pay_ios
```
